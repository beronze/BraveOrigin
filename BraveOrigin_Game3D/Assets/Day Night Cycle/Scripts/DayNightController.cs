...
public class DayNightController : MonoBehaviour {
    float dateAndTimeVar = System.DateTime.Now.Hour + System.DateTime.Now.Minute / 60f;
    ...
    public void TimePlus(float timeH)
    {
        currentTime += timeH;
    }

    public void TimeDel(float timeH)
    {
        currentTime -= timeH;
    }
	...
	void ControlLight() {
		//Rotate light
		xValueOfSun = -(-270.0f-currentTime*15.0f);
